  ...
  private readonly List<NewsDto.Index> _items = new()
        {
            ...
            new NewsDto.Index { Id = 3, Title = "Cafeteria menu updated", PublishDate = DateTime.UtcNow.AddDays(-1), Content = "Try the new vegetarian options at the cafeteria.", Author = "Catering" },
